...
const PERKS = [
  {
    ...
    description:
      "Get your assets delivered to your email in seconds and download them rignt away",
  },
  {
  ...
  },
  {
    ...
    icon: Leaf,
    description:
      "We've pledged 1% of our sales to the preservation and restoration of the nature ",
  },
];
